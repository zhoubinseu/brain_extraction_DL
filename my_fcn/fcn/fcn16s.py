...
class fcn16s():
    def build(self, x, class_num, channel, wd, train=True):
        ...
        self.pooling4_conv = _conv_layer_without_relu(self.pooling4, [1, 1, 512, class_num], 'pool4_1x1conv', wd=wd)  #[256,8,16,2]
        ...
        self.upscore = _upscore_layer(self.fuse_pool4, shape=tf.shape(x), ksize=32, stride=16,
